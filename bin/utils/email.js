    ...
    switch (contentType){
        ...
        case 3: //survey new
            mailOptions = {
                ...
                html: '<b>Здраствуйте '+ receiver.login +'<br> Появился новый опрос'+ content.name+'</b>' // html body
            };
            break;
        case 4: //survey anotation
            mailOptions = {
                ...
                text: 'Здравствуйте', // plain text body
                html: '<b>Здраствуйте '+ receiver.login +'<br> Обратите внимание на опрос'+ content.name+'</b>' // html body
            };
            break;
